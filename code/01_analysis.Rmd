...
lit_review <- read_csv("/home/jae/linked_fate_review/raw_data/linked_fate_review2.csv")
...
lit_review %>%
  ...
  geom_line() +
  theme_pubr() +
  labs(title = "Publication trend on linked fate", x = "Publication years", y = "Cumulative count") + scale_x_continuous(breaks= c(2000, 2005, 2010, 2015)) +
...
lit_review %>%
  ...
  ggplot(aes(x = fct_reorder(group, prop), y = prop)) +
  geom_col() +
...
1. Linked fate research has been growing and expanding
